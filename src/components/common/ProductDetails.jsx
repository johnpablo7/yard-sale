...
export const ProductDetails = () => {
  ...
  return (
    <div className="fixed w-[384px] h-auto rounded top-16 md:right-0 bg-white border-white outline-none">
      <div className="relative">
        <button
          onClick={() => setProductWidget(false)}
          className="absolute bg-white text-3xl rounded-full p-3 left-4 top-6"
        >
      ...
      <div className="flex flex-col px-9 py-5">
        ...
        <p className="text-lg text-boulder mb-5">Retro refrigerator</p>
        <p className="text-boulder mb-9">
